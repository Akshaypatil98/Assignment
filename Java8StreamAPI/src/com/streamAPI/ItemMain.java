...
public class ItemMain {
	...
	public static void main(String[] args) {
		...
		l.add(new ItemStream(101, "parle", LocalDateTime.of(2022, 4, 23, 4, 30), LocalDateTime.of(2023, 4, 23, 4, 30),
				2000));
		l.add(new ItemStream(102, "sunfist", LocalDateTime.of(2020, 5, 20, 8, 00), LocalDateTime.of(2021, 5, 20, 8, 00),
				4000));
		l.add(new ItemStream(103, "monaco", LocalDateTime.of(2021, 7, 21, 7, 20), LocalDateTime.of(2022, 7, 21, 7, 20),
				8000));
		l.add(new ItemStream(104, "borbon", LocalDateTime.of(2019, 9, 12, 6, 37), LocalDateTime.of(2020, 9, 12, 6, 37),
				3000));
		l.add(new ItemStream(105, "derymilk", LocalDateTime.of(2019, 9, 12, 6, 37),
